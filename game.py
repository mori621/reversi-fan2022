...
class State:
    # 初期化
    def __init__(self, pieces=None, enemy_pieces=None, depth=0, pieces_history=None, enemy_pieces_history=None):
        # 方向定数
        ...
        # 一手前の配置
        self.pieces_history = pieces_history
        self.enemy_pieces_history = enemy_pieces_history
        if pieces_history == None or enemy_pieces_history == None:
            self.pieces_history = []
            self.enemy_pieces_history = []
    ...
    def next(self, action):
        ...
        self.pieces_history.copy(), self.enemy_pieces_history.copy())
        if action != 64:
        ...
        # 
        state.pieces_history.append(self.pieces.copy())
        state.enemy_pieces_history.append(self.enemy_pieces.copy())
        # state.before_depth = self.depth
